(function () {
    ...
    function controller($rootScope, $scope, $modal, _actionGroups, _allClasses, _actionsByName, _profile) {
        ...
        $scope.$on('profile.updated', onProfileUpdated);
        ...
        function onProfileUpdated(ev, cls) {
            $scope.$apply(function () {
                $scope.crafter.stats[cls] = _profile.crafterStats[cls];
                selectActionsByLevel(cls);
                _profile.crafterStats[cls].actions = $scope.crafter.stats[cls].actions;
                _profile.persist();
            });
        }
